  ...
  if (category) {
    ...
    switch (category) {
      case "TRACK":
        ...
        properties.color = new Cesium.Cartesian3(0.26, 0.75, 0.96);
        properties.outlineColor = new Cesium.Cartesian3(0.26, 0.8, 0.96);
        ...
        material: new Cesium.PolylineOutlineMaterialProperty({
          color: new Cesium.CallbackProperty(function () {
            return new Cesium.Color(
              ...
              entity.color.y,
              entity.color.z,
              entity.opacity * globalOpacity
            );
          }),
          outlineWidth: properties.outlineWidth,
          outlineColor: new Cesium.CallbackProperty(function () {
            return new Cesium.Color(
              entity.outlineColor.x,
              entity.outlineColor.y,
              entity.outlineColor.z,
              0.1
            );
          }),
        }),
